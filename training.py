...
normalization_layer = layers.Rescaling(1./255) #NORMALIZACIÓN
train_ds_rescaled =train_ds.map(lambda x, y: (normalization_layer(x), y))
...
tf.keras.models.save_model(
    model,
    filepath = './ai_models/test_model5.h5',
    overwrite=True,
